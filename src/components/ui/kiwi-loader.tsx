// Kiwi Walk loader by AatreyuShau (MIT License)
// https://uiverse.io/AatreyuShau/lazy-quail-10
import styles from "./kiwi-loader.module.css";

export function KiwiLoader() {
  return (
